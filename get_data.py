...
# Get Any place weather for past week
...
plt.title(f'{placeto} Weather - Past 7 Days')
plt.legend()
...
# Save to CSV
df.to_csv(f'data/{placeto}_weather.csv', index=False)
print(f"Data saved to data/{placeto}_weather.csv")